"""Installs huggingface_hub==0.26.2 on remote server and checks imports."""
import paramiko
import sys
...
try:
    ...
    print("\nInstalling huggingface_hub==0.26.2...")
    ...
    test_cmd = (
        ...
        "eval \"$(conda shell.bash hook)\"\n"
        f"conda activate {remote_conda_dir}\n"
        "python -c 'import momentfm; import chronos; import timesfm; print(\"SUCCESS: All models imported successfully with huggingface_hub==0.26.2!\")'"
    )
