...
\midrule
\multicolumn{6}{l}{\textit{Modelos clásicos de ML (validación cruzada KFold para $R^2$, entrenamiento para MAE/RMSE)$^\S$}} \\
Random Forest & Ensamble & 0.88$^\S$ & 1.04$^\S$ & $-$2.41 & --- \\
KNN (k=3) & Instancias & 1.69$^\S$ & 2.20$^\S$ & $-$3.57 & --- \\
Decision Tree & Árbol & 0.00$^*$ & 0.00$^*$ & 1.00$^*$ & --- \\
\midrule
\multicolumn{6}{l}{\textit{Modelos de Deep Learning custom (MAE/RMSE/R² promediados sobre ambas dimensiones, validación CV)}} \\
...
\midrule
\multicolumn{6}{l}{\textit{Modelos fundacionales (métricas de validación por dimensión, zero-shot/fine-tuning)}} \\
